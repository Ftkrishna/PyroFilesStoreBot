...
from pyrogram.enums import ChatType  # Updated import
...
async def main(bot: Client, message: Message):
    if message.chat.type == ChatType.PRIVATE:  # Updated
    ...
    elif message.chat.type == ChatType.CHANNEL:  # Updated
...
async def unban(c: Client, m: Message):
    ...
    try:
        ...
        try:
            await c.send_message(
                user_id,
                "You are unbanned to use the bot.\n\n**Message from the admin**"
            )
            unban_log_text += '\n\nUser notified successfully!'
        except:
            traceback.print_exc()
